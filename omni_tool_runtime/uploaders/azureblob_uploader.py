...
class AzureBlobUploader:
    ...
    def _client(self):
        try:
            ...
            raise RuntimeError(f"azure-storage-blob not installed (install omni-tool-runtime[azure]): {e}")
        ...
        try:
            ...
            raise RuntimeError(f"azure-identity not installed (install omni-tool-runtime[azure]): {e}")
